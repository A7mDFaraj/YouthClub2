...
export default function Hero3() {
  return (
    <section className="relative w-full min-h-[100dvh] bg-[#ffefd0]/30 flex flex-col items-center justify-center overflow-hidden font-sans pb-16 pt-[100px] sm:pt-[120px] lg:pt-[140px]" dir="rtl">
      {/* Remotion Background Video */}
      <video
        autoPlay
        loop
        muted
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1, delay: 0.5 }}
        className="absolute top-[52px] sm:top-[64px] lg:top-[72px] right-0 flex pointer-events-none z-0 opacity-70 md:opacity-80 hover:opacity-100 transition-opacity"
      >
